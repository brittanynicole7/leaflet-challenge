...
console.log(data);
    ...
    function selectColor(depth) {
     ...
     //Create a circle marker for each set of coordinates. Code developed with the help of a tutor and 
     // the following website: https://groups.google.com/g/leaflet-js/c/jsuGLzD5VsQ?pli=1
    ...
    //Create the legend. The following two blocks of code were developed with the help of a tutor and the 
    // CitiBikes in class assignment. 
